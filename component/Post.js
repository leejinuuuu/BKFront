      ...
      for (let i = 0; i < Math.ceil(mainPost.length / 4) * 4; i += 4) {
        tempArr.push(
          <Row>
            ...
            <Col xs={"3"}>
              {i >= mainPost.length - 1 ? null : (
                <SimplePostCard postInfo={mainPost[i + 1]} />
              )}
            </Col>
            <Col xs={"3"}>
              {i >= mainPost.length - 2 ? null : (
                <SimplePostCard postInfo={mainPost[i + 2]} />
              )}
            </Col>
            <Col xs={"3"}>
              {i >= mainPost.length - 3 ? null : (
                <SimplePostCard postInfo={mainPost[i + 3]} />
              )}
            </Col>
          </Row>
        );
